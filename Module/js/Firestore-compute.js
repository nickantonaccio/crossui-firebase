...
xui.Class('Module.Firestore-compute', 'xui.Module',{
    Instance:{
        ...
        getFirebaseConfig:function(){
            return {"GOOGLE_OAUTH_CLIENT_ID":"","signInMethods":"EmailPassword;Github;Google","config":{"apiKey":"AIzaSyCU7fMbnkptvbXWef-XB7SAsH084hyyv44","authDomain":"com-pute.firebaseapp.com","databaseURL":"com-pute","projectId":"com-pute.appspot.com","storageBucket":"1077949649645","messagingSenderId":"1:1077949649645:web:b9cdaa8404f4304b2ab2e4","appId":"G-KGW0DL4YNP"}};
        },
        ensureFirebaseAuth:function(){
            ...
            function showFirebaseLogInLayer(){
                ...
                var loginLayer =  (new xui.UI.Div())
                    ...
                    .setPanelBgClr("#fff")
                    .setIframeAutoLoad("{/}Module/js/Module.Firestore-compute/pages/FirebaseLoginLayer.html");
                // ensure effects
